<x-layouts.app>
    <x-slot:slot>
        <main class="h-full w-full px-12 py-10">
            <h1 class="text-3xl font-medium">Sejarah Desa</h1>
            <section class="mt-4 flex flex-col gap-4">
                <h2 class="text-xl">Sejarah Pembentukan Desa</h2>
                <p>
                ...
                <h2 class="text-xl pt-5">Daftar Pejabat Kepala Desa</h2>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Debitis rerum delectus quam ad fugit voluptatibus, nemo
                    dolores eveniet, dignissimos eos reprehenderit perspiciatis
